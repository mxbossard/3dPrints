...
//#define HEATER_0_MAXTEMP 9999
#define HEATER_0_MAXTEMP 275
#define HEATER_1_MAXTEMP 275
#define HEATER_2_MAXTEMP 275
#define BED_MAXTEMP 120
//#define BED_MAXTEMP 9999
...
// From PID autotune (M303 E0 S200 C8) http://reprap.org/wiki/PID_Tuning
...
#define ENABLE_AUTO_BED_LEVELING // Delete the comment to enable (remove // at the start of the line)
  ...
  #define X_PROBE_OFFSET_FROM_EXTRUDER 29 //-45 //-25
  #define Y_PROBE_OFFSET_FROM_EXTRUDER 0 //-40 //-29
...
//it is highly recommended you let this Z_SAFE_HOMING enabled!!!
 ...
 #define Z_SAFE_HOMING   // This feature is meant to avoid Z homing with probe outside the bed area.
    ...
    #define Z_SAFE_HOMING_X_POINT 40 //(X_MAX_LENGTH/2)    // X point for Z homing when homing all axis (G28)
    #define Z_SAFE_HOMING_Y_POINT 40 //(Y_MAX_LENGTH/2)    // Y point for Z homing when homing all axis (G28)
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {160,160,800,2000}  // default steps per unit for ultimaker 
#define DEFAULT_MAX_FEEDRATE          {1000, 1000, 150, 500}    // (mm/sec)    
...
//#define PLA_PREHEAT_HPB_TEMP 00
#define PLA_PREHEAT_HPB_TEMP 70
#define PLA_PREHEAT_FAN_SPEED 255   // Insert Value between 0 and 255

#define ABS_PREHEAT_HOTEND_TEMP 240
//#define ABS_PREHEAT_HPB_TEMP 00
