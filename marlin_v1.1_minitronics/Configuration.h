...
#define STRING_CONFIG_H_AUTHOR "marlin v115 config MBD.0" // Who made the changes.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 800, 1400 } // AVANT: Z = 2000
...
#define Y_MIN_POS 10
#define Z_MIN_POS 0
#define X_MAX_POS 180 //X_BED_SIZE
...
//#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT 50 //((X_BED_SIZE) / 2)    // X point for Z homing when homing all axis (G28).
  #define Z_SAFE_HOMING_Y_POINT 30 //((Y_BED_SIZE) / 2)    // Y point for Z homing when homing all axis (G28).
#endif
...
#define DEFAULT_KEEPALIVE_INTERVAL 120  // Number of seconds between "busy" messages. Set with M113.
